                ...
                <div className="grid grid-cols-7 gap-y-8 gap-x-8 sm:gap-x-12 md:gap-x-16 mb-8 w-full max-w-5xl xl:max-w-6xl">
                    {days.map((day) => (
                        <div key={day} className="flex flex-col items-center mb-2">
                            <button
                                className="h-12 w-12 sm:h-16 sm:w-16 md:h-20 md:w-20 text-lg sm:text-xl md:text-2xl font-bold rounded-2xl bg-neutral-950/95 border border-white/10 shadow-[0_12px_48px_0_rgba(0,0,0,1)] transition-all duration-200 ease-in-out text-white focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer mb-2 hover:bg-white hover:text-[#18181b] active:bg-neutral-200 active:text-[#18181b]"
